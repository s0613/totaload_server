...
class AuthControllerTest {
    ...
    void login_shouldReturn200WithTokens() throws Exception {
        ...
        loginRequest.setUsernameOrEmail("login-test@example.com");
    ...
    void login_shouldReturn401WhenInvalidCredentials() throws Exception {
        ...
        LoginRequest loginRequest = new LoginRequest();
        loginRequest.setUsernameOrEmail("wrong-pass@example.com");
    ...
    void login_shouldReturn400WhenOAuth2User() throws Exception {
        ...
        // Attempt local login
        LoginRequest loginRequest = new LoginRequest();
        loginRequest.setUsernameOrEmail("oauth2@example.com");
        loginRequest.setPassword("Password123!");
